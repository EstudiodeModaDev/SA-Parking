...
export class RegistroVehicularService {
  ...
  constructor(graph: GraphRest, hostname: string = 'estudiodemoda.sharepoint.com', sitePath: string = '/sites/TransformacionDigital/IN/SA', listName: string= 'RegistroVehicular') {
    this.graph = graph;
